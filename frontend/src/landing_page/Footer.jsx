      ...
      <div className="container pb-5">
        <div className="row mb-5 mt-5">
          <div className="col-lg-3 col-md-12 ">
            <img
              src="media\TradingWave_logo-1.png"
              alt="Logo"
              className="fluid"
              style={{ width: "170px" }}
            />
            <p className="mt-4 text-black-50">
              © 2010 - 2026, Tradingwave Broking Ltd. All rights reserved.
            </p>
          </div>
          <div className="col-lg-9 col-md-12">
            <div className="row ">
              <div className="col-lg-3 col-md-3 col-sm-12 mb-4">
                ...
                <div className="hover-color footer-link ">
        ...
        <div className=" hover-color footer-bottom-link d-flex flex-wrap gap-4  ">
          <a href="">NSE</a>
          <a href="">BSC</a>
          <a href="">MCX</a>
