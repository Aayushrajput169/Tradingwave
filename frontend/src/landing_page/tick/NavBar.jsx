    ...
    <nav className="navbar border-bottom">
      <div className="container-fluid px-4 d-flex justify-content-between align-items-center">
        <a className="navbar-brand" href="#">
          <img
            src="media/TradingWave_logo.jpeg"
            alt="logo"
            style={{ width: "12rem" }}
          />
        </a>
        <ul className="dropdown tick-dropdown list-unstyled">
          <li className="nav-item dropdown tick-navbar-profile">
            <a
            ...
            <ul
              className="dropdown-menu dropdown-menu-end tick-navbar text-muted mt-2"
            ...
            >
              ...
              <li>
                <a className="dropdown-item fw-medium tick-navbar-btn" href="#">
              ...
              <li>
                <Link
                  className="dropdown-item fw-medium tick-navbar-btn logout"
                  onClick={Logout}
                >
